...
public class ExecuteScriptCommand implements Command {
    ...
    public void execute(String x) {
        ...
        try {
                ...
                if (splittedCommand[0].equals("execute_script")) {
                    if (paths.add(splittedCommand[1])) {
                        try {
                            ...
                            System.out.println(splittedCommand[1] + ": file with script not found, it can only be readable");
                        }
                    } else {
                        System.out.println(commands.get(i) + ": command ignored because of recursion");
                    }
            ...
            System.out.println(x + ": file with script not found, it can only be readable");
        }
    }
}
